...
import model_utils
from model_utils import save_if_better, call_sam
...
class Trainer():
    ...
    def __init__(self, sync_dir=None, patch_size=572, max_workers=12):
        ...
        # approx 30 minutes
        self.max_epochs_without_progress = 20
...
#                hashes.append(self.hash_file(fpath))
#        return sorted(hashes)
    ...
    def train_one_epoch(self):
        ...
        train_loader = DataLoader(self.train_set, self.bs, shuffle=False,
        ...
        for step, (photo_tiles,
            ...
            outputs = call_sam(self.model, photo_tiles)
...
#         return hashlib.md5(buffer.read()).hexdigest()
    ...
    def validation(self):
        ...
        if self.epochs_without_progress >= self.max_epochs_without_progress:
            ...
            self.training = False
            self.write_message(message)
            message = (f'exiting program with code 0')
            self.log(message)
            sys.exit(0)
